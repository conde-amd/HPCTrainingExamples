#!/bin/bash
# Script to profile TinyTransformer V4 with rocprofv3 kernel trace
...
echo "Starting rocprofv3 kernel trace collection for TinyTransformer V4..."
