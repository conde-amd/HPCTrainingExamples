...
echo ""
echo "Running: rocprofv3 --stats -- python tiny_llama_v4.py --batch-size 8 --seq-len 128 --num-steps 10"
echo ""

cd "$OUTPUT_DIR"
rocprofv3 --stats -- python ../../tiny_llama_v4.py --batch-size 8 --seq-len 128 --num-steps 10
ROCPROF_EXIT=$?
