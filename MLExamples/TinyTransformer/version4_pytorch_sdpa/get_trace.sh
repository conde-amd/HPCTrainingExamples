...
echo "=========================================="
echo "rocprofv3 Runtime Trace - Version 4"
echo "=========================================="
echo ""
...
echo ""
echo "Running: rocprofv3 --runtime-trace --output-format pftrace -- python tiny_llama_v4.py --batch-size 8 --seq-len 128 --num-steps 10"
echo ""

cd "$OUTPUT_DIR"
rocprofv3 --runtime-trace --output-format pftrace -- python ../../tiny_llama_v4.py --batch-size 8 --seq-len 128 --num-steps 10
ROCPROF_EXIT=$?
