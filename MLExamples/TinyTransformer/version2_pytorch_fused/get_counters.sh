...
echo "=========================================="
echo "rocprofv3 Hardware Counters - Version 2"
echo "=========================================="
echo ""
...
echo "Running: rocprofv3 --kernel-trace -- python tiny_llama_v2.py --batch-size 8 --seq-len 128 --num-steps 10"
echo ""

cd "$OUTPUT_DIR"
rocprofv3 --kernel-trace -- python ../../tiny_llama_v2.py --batch-size 8 --seq-len 128 --num-steps 10
ROCPROF_EXIT=$?
