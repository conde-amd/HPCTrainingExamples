...
echo "=========================================="
echo "rocprofv3 Runtime Trace - Version 2"
echo "=========================================="
echo ""
...
echo ""
echo "Running: rocprofv3 --runtime-trace --output-format pftrace -- python tiny_llama_v2.py --batch-size 8 --seq-len 128 --num-steps 10"
echo ""
