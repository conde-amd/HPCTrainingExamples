...
echo "=========================================="
echo "rocprof-sys Profiling - TinyTransformer V2"
echo "=========================================="
echo ""
...
echo "Running: rocprof-sys-run --profile --trace -- python tiny_llama_v2.py --batch-size 8 --seq-len 128 --num-steps 10"
echo ""

cd "$OUTPUT_DIR"
rocprof-sys-run --profile --trace -- python ../../tiny_llama_v2.py --batch-size 8 --seq-len 128 --num-steps 10
ROCPROF_EXIT=$?
