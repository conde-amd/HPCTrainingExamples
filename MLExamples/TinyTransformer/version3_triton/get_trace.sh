...
echo "=========================================="
echo "rocprofv3 Runtime Trace - Version 3"
echo "=========================================="
echo ""
...
echo ""
echo "Running: rocprofv3 --runtime-trace --output-format pftrace -- python tiny_llama_v3.py --batch-size 8 --seq-len 128 --num-steps 10"
echo ""
