#!/bin/bash
# Script to profile TinyTransformer V3 with rocprofv3 kernel trace
...
echo "Starting rocprofv3 kernel trace collection for TinyTransformer V3..."
